...
Read_Live_Data_ScreenViewBase::Read_Live_Data_ScreenViewBase() :
    ...
    flexButtonCallback(this, &Read_Live_Data_ScreenViewBase::flexButtonCallbackHandler)
{
...
void Read_Live_Data_ScreenViewBase::flexButtonCallbackHandler(const touchgfx::AbstractButtonContainer& src)
{
    if (&src == &home_button)
    {
        //home_Button_int
